    ...
    <div className="page page--home">
      ...
      <div className="card text-center">
        ...
        <div className="card-body">
          ...
          <a className="btn btn-primary white"><NavLink to={Routes.VEGETABLES}>Groentenlijst</NavLink></a>
        </div>
      ...
      <div className="card text-center">
        ...
        <div className="card-body">
          ...
          <a className="btn btn-primary white"><NavLink to={Routes.FRUIT}>Lijst van fruit</NavLink></a>
        </div>
        <div className="card-footer text-muted">
        </div>
      </div>
